...
\usepackage{fullpage}
\usepackage[bibencoding=utf8,style=phys,maxbibnames=6]{biblatex}
...
\footnotetext{I am somewhat loose with the code for the sake of brevity, for example replacing the ROOT types with the normal C\texttt{++} ones.}
...
\begin{appendices}
    ...
    \section{Some more detail on the code}\label{app:code}
